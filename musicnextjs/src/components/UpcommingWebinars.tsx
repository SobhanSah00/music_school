    ...
    <div className='p-12 bg-gradient-to-b from-black to-gray-900'>
        <div className='max-w-7xl max-auto px-4 sm-px-6'>
            <div className='text-center'>
                <h2 className=" ml-20 text-base text-teal-600 font-semibold tracking-wide uppercase ">FEATURED WEBINARS</h2>
                <p className=" ml-20 mt-2 text-3xl leading-8 font-extrabold tracking-tight text-white sm:text-4xl ">Enhance Your Musical Journey</p>
            </div>
            <div className='mt-10 text-center ml-40'>
